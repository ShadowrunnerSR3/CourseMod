package net.shadowrunner.course_mod;
...
import net.shadowrunner.course_mod.block.ModBlocks;
import net.shadowrunner.course_mod.item.ModCreativeModeTabs;
...
public class CourseMod {
    ...
    public static final String MOD_ID = "course_mod";
